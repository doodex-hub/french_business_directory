...
- Modul punya `FUNCTIONAL_SPEC.md` lama? **Ya** — hasil backfill 2026-08-07 di folder terpisah `D:\Kuncoro\doodex\repo\french-business-directory-17\doc-dev\backfill\spec\{fr_business_directory,personal_email_usage}\01A_FUNCTIONAL_SPEC.md` (+ `01B_ACCEPTANCE_CRITERIA.md`). Dev eksplisit setuju dipakai sebagai dasar.
